...
<br>
  <div id="head">
  <nav><ul><li>
     <a href="/todos" class="btn btn-primary" >Robotics</a> </li>
      <li><a href="/quizy" class="btn btn-primary" >start Quiz</a> </li>
      <li><a href="/logout" class="btn btn-primary" >Logout</a> </li></nav>  
    </div>
...
<h3>Unit 1: Introduction to Entreprenuership</h3>
        ...
        dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula,
         porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra
          ...
          Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies
           ...
           sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit

 <img src="assets/images/df.jpeg" width="300px" height="200px" alt="image 1"/>
      <img src="assets/images/ghtu.jpeg" width="300px" height="200px" alt="image 2"/>
    Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo 
    ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis
     parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec,
      pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo,
        ...
        dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula,
         porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra
          ...
          Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies
           nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, 
           sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit
            vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis
